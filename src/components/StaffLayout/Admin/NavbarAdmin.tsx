	...
	return (
		...
		>
			<Panel
				...
				key="2"
			>
				<Link href="/staff/documents/pending">
					<div
				...
				<Link href="/staff/documents/reviewed">
					<div
						className={`text-white flex flex-row items-center justify-start mb-1 hover:bg-gray-400 rounded-full px-1 hover:text-white ${
							collapsed && "my-2 justify-center"
				...
				<Link href="/staff/documents/revisions">
					<div
						className={`text-white flex flex-row items-center justify-start mb-1 hover:bg-gray-400 rounded-full px-1 hover:text-white ${
							collapsed && "my-2 justify-center"
				...
				<Link href="/staff/documents/reupload">
					<div
						className={`text-white flex flex-row items-center justify-start mb-1 hover:bg-gray-400 rounded-full px-1 hover:text-white ${
							collapsed && "my-2 justify-center"
				...
				<Link href="/staff/documents/approved">
					<div
						className={`text-white flex flex-row items-center justify-start mb-1 hover:bg-gray-400 rounded-full px-1 hover:text-white ${
							collapsed && "my-2 justify-center"
